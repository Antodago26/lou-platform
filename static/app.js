...
(function () {
  ...
  function getLandingCSS() {
    return [
      ...
      ':root{--dark:#1E2A44;--blue:#2A6670;--blue-light:#0ea5e9;--gray-50:#F7F4EE;--gray-100:#EFEAE0;--gray-300:#D4CEC2;--gray-500:#6B7280;--gray-700:#4A5568;--white:#fff;--green:#059669;--radius:12px}',
  ...
  function injectChatCSS() {
    var s = ce('style', '', [
      ...
      '.chat-msg.bot{background:#EFEAE0;color:#1E2A44;align-self:flex-start;border-bottom-left-radius:4px}',
  ...
  function _pfFetchSuggestions(query, dd, input) {
    ...
    fetch(url).then(function (r) { return r.json(); }).then(function (data) {
      ...
      items.forEach(function (el) {
        el.addEventListener('mouseenter', function () { el.style.background = '#E6E0D4'; });
  ...
  window.showScoreDetail = function(el, e) {
    ...
    tip.innerHTML = '<div style="font-weight:700;font-size:14px;margin-bottom:4px;color:#1E2A44">Détail du score</div>' +
        ...
        '<button onclick="event.stopPropagation();this.parentNode.remove()" style="margin-top:10px;width:100%;background:#EFEAE0;border:1px solid #D4CEC2;border-radius:6px;padding:5px 12px;cursor:pointer;font-size:12px;color:#4A5568">Fermer</button>';
        ...
        if (!data.properties || data.properties.length === 0) {
          ...
          if (currentNewOnly) {
            ...
            list.innerHTML = '<div class="dash-empty">' +
              ...
              '</div>' +
              '<p style="margin-top:12px;color:#6B7280;font-size:13px">Actualisez la page dans un instant, ou <a href="#" class="open-chat-link" style="color:#2A6670;cursor:pointer">discutez avec Lou</a> en attendant.</p>' +
  ...
  function renderPropertyCard(p) {
    ...
    var daysColor = daysOnline <= 3 ? '#059669' : daysOnline <= 14 ? '#2A6670' : daysOnline <= 30 ? '#d97706' : '#6B7280';
  ...
  function getDashCSS() {
    return [
      'body{margin:0;background:#F7F4EE;color:#1E2A44;font-family:Inter,system-ui,sans-serif;-webkit-font-smoothing:antialiased;font-feature-settings:"ss01" on,"ss02" on}',
      ...
      // fond teal-deep on prend sage-soft (#C2D1B3), mieux lisible que sage
      // brut tout en gardant la lecture "signature" distincte du teal.
      '.dash-nav .wordmark{color:#F7F4EE;font-size:22px;font-variation-settings:"opsz" 144}',
      '.dash-nav .wordmark__point{color:#C2D1B3}',
      '.dash-nav .wordmark__chevron{stroke:#C2D1B3}',
      ...
      '.admin-table td{padding:10px 8px;border-bottom:1px solid #EFEAE0}',
      ...
      '.dash-stat.stat-active{border-color:#2A6670;background:#E6E0D4;box-shadow:0 4px 16px rgba(42,102,112,.15)}',
      '.dash-stat.stat-active .dash-stat-num{color:#2A6670}',
      '.dash-stat.stat-active .dash-stat-lbl{color:#2A6670;font-weight:600}',
      '.new-filter-banner{display:flex;align-items:center;justify-content:space-between;background:#E6E0D4;border:1px solid #CEDFE1;border-radius:10px;padding:12px 18px;margin-bottom:16px;font-size:14px;color:#2A6670;font-weight:600}',
      ...
      '.nearby-banner-active{background:#E6E0D4;border-color:#CEDFE1;color:#2A6670}',
      ...
      '.ptag{padding:6px 14px;background:#EFEAE0;border-radius:50px;font-size:13px;color:#6B7280}',
      ...
      '.pf-chip{padding:7px 14px;border-radius:20px;font-size:13px;cursor:pointer;border:1px solid #D4CEC2;background:#F7F4EE;color:#6B7280;transition:all .15s;user-select:none}',
      ...
      '.pf-zone{display:flex;align-items:center;gap:10px;background:#F7F4EE;border:1px solid #D4CEC2;border-radius:8px;padding:8px 14px;font-size:14px}',
      ...
      '.pf-cancel-btn{padding:11px 24px;background:#EFEAE0;color:#6B7280;border:none;border-radius:10px;font-size:14px;cursor:pointer}',
      ...
      '.prop-img-placeholder{width:100%;height:100%;background:linear-gradient(135deg,#EFEAE0,#D4CEC2);display:flex;align-items:center;justify-content:center;color:#6B7280;font-size:13px}',
      ...
      '.score-mini-bar{flex:1;height:5px;background:#EFEAE0;border-radius:3px;overflow:hidden}',
      ...
      // Card footer
      '.prop-footer{display:flex;justify-content:space-between;align-items:center;padding-top:12px;border-top:1px solid #EFEAE0}',
      ...
      '.fav-empty{padding:64px 32px;background:linear-gradient(135deg,#F7F4EE 0%,#fff 100%);border:1px solid #D4CEC2}',
      ...
      '.detail-gallery-empty{width:100%;height:200px;background:#EFEAE0;display:flex;align-items:center;justify-content:center;color:#6B7280;font-size:15px}',
      ...
      '.detail-section h3{font-size:15px;font-weight:700;color:#1E2A44;margin-bottom:12px;padding-bottom:8px;border-bottom:1px solid #EFEAE0}',
      ...
      '.detail-feat{padding:6px 14px;background:#E6E0D4;border:1px solid #CEDFE1;border-radius:20px;font-size:13px;color:#2A6670}',
      ...
      '.detail-source-text{padding:10px 20px;background:#EFEAE0;border-radius:10px;font-size:14px;color:#6B7280;text-transform:capitalize}',
      ...
      '.score-legend-body{background:#F7F4EE;border:1px solid #D4CEC2;border-radius:12px;padding:16px 20px;margin-top:8px}',
      ...
      '.fav-note-preview{font-size:12px;color:#6B7280;background:#F7F4EE;padding:6px 10px;border-radius:6px;margin-bottom:8px;border-left:3px solid #2A6670;font-style:italic}',
      '.fav-card-footer{display:flex;justify-content:space-between;align-items:center;padding-top:10px;border-top:1px solid #EFEAE0}',
      ...
      '.note-cancel-btn{padding:8px 16px;background:#EFEAE0;border:none;border-radius:8px;font-size:13px;cursor:pointer;color:#6B7280}',
      ...
      '.compare-table td{padding:10px;text-align:center;border-bottom:1px solid #EFEAE0}',
      ...
      '.map-sidebar{width:380px;min-width:320px;height:100%;overflow-y:auto;background:#F7F4EE;border-right:1px solid #D4CEC2}',
