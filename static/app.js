...
(function () {
  ...
  var ICO = {
    ...
    wolf: '<svg width="48" height="48" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg"><rect width="48" height="48" rx="12" fill="#1F6B6E"/><circle cx="21" cy="20" r="11" fill="none" stroke="#fff" stroke-width="2.8"/><line x1="29" y1="28" x2="39" y2="38" stroke="#fff" stroke-width="2.8" stroke-linecap="round"/><path d="M21 13 L14 19 L15.5 19 L15.5 26 L26.5 26 L26.5 19 L28 19 Z" fill="#fff" opacity="0.95"/><rect x="19.5" y="22" width="3" height="4" rx="0.5" fill="#1F6B6E"/></svg>',
  ...
  function showAuthModal() {
    ...
    overlay.innerHTML = [
      ...
      '<h2><svg style="width:28px;height:28px;vertical-align:middle;margin-right:8px" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg"><rect width="48" height="48" rx="12" fill="#1F6B6E"/><circle cx="21" cy="20" r="11" fill="none" stroke="#fff" stroke-width="2.8"/><line x1="29" y1="28" x2="39" y2="38" stroke="#fff" stroke-width="2.8" stroke-linecap="round"/><path d="M21 13 L14 19 L15.5 19 L15.5 26 L26.5 26 L26.5 19 L28 19 Z" fill="#fff" opacity="0.95"/><rect x="19.5" y="22" width="3" height="4" rx="0.5" fill="#1F6B6E"/></svg>Bon Home</h2>',
  ...
  function showLanding() {
    ...
    nav.innerHTML =
      '<a href="/" class="nav-logo">' +
        '<svg class="logo-wolf" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg"><rect width="48" height="48" rx="12" fill="#1F6B6E"/><circle cx="21" cy="20" r="11" fill="none" stroke="#fff" stroke-width="2.8"/><line x1="29" y1="28" x2="39" y2="38" stroke="#fff" stroke-width="2.8" stroke-linecap="round"/><path d="M21 13 L14 19 L15.5 19 L15.5 26 L26.5 26 L26.5 19 L28 19 Z" fill="#fff" opacity="0.95"/><rect x="19.5" y="22" width="3" height="4" rx="0.5" fill="#1F6B6E"/></svg>' +
    ...
    hero.innerHTML =
      ...
      '<div class="hero-visual">' +
        '<svg class="hero-wolf-icon" width="180" height="180" viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg"><circle cx="35" cy="33" r="18" fill="none" stroke="rgba(255,255,255,0.95)" stroke-width="4.5"/><line x1="48" y1="46" x2="65" y2="63" stroke="rgba(255,255,255,0.95)" stroke-width="4.5" stroke-linecap="round"/><path d="M35 21 L24 30 L27 30 L27 41 L43 41 L43 30 L46 30 Z" fill="rgba(255,255,255,0.95)"/><rect x="33" y="35" width="5" height="6" rx="1" fill="rgba(31,107,110,0.6)"/></svg>' +
  ...
  function featureCard(svgInner, title, desc) {
    return '<div class="feature-card">' +
      '<div class="feature-icon"><svg viewBox="0 0 24 24" fill="none" stroke="#1F6B6E" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">' + svgInner + '</svg></div>' +
      '<h3>' + title + '</h3>' +
      '<p>' + desc + '</p>' +
    '</div>';
  }
  ...
  function getLandingCSS() {
    return [
      ...
      ':root{--dark:#1A2332;--blue:#1F6B6E;--blue-light:#0ea5e9;--gray-50:#F5F1EA;--gray-100:#EDE8DF;--gray-300:#D4CEC2;--gray-500:#6B7280;--gray-700:#4A5568;--white:#fff;--green:#059669;--radius:12px}',
      ...
      '.btn-primary:hover{background:var(--blue-light);transform:translateY(-1px);box-shadow:0 4px 16px rgba(31,107,110,.3)}',
      ...
      '.feature-card:hover{border-color:var(--blue);box-shadow:0 8px 32px rgba(31,107,110,.08);transform:translateY(-4px)}',
      '.feature-icon{width:48px;height:48px;background:rgba(31,107,110,.1);border-radius:12px;display:flex;align-items:center;justify-content:center;margin-bottom:16px}',
      ...
      '.lou-auth-box{background:#fff;border-radius:16px;padding:36px;width:400px;max-width:90vw;box-shadow:0 20px 60px rgba(0,0,0,.3);position:relative;color:#1A2332}',
      '.lou-auth-box .close-btn{position:absolute;top:12px;right:16px;background:none;border:none;font-size:22px;cursor:pointer;color:#6B7280}',
      '.lou-auth-box .close-btn:hover{color:#1A2332}',
      '.lou-auth-box h2{font-size:24px;margin:0 0 4px;font-family:Fraunces,Georgia,serif}',
      '.lou-auth-box .sub{font-size:14px;color:#6B7280;margin-bottom:20px}',
      '.lou-auth-box input{width:100%;padding:12px 14px;border:1px solid #D4CEC2;border-radius:10px;margin-bottom:12px;font-size:14px;box-sizing:border-box;outline:none;font-family:"Inter",sans-serif}',
      '.lou-auth-box input:focus{border-color:#1F6B6E;box-shadow:0 0 0 3px rgba(31,107,110,.1)}',
      '.auth-submit{width:100%;padding:13px;border:none;border-radius:10px;background:#1F6B6E;color:#fff;font-size:15px;font-weight:600;cursor:pointer;transition:background .2s;font-family:"Inter",sans-serif}',
      '.auth-submit:hover{background:#174E51}',
      '.lou-auth-switch{text-align:center;margin-top:14px;font-size:13px;color:#6B7280}',
      '.lou-auth-switch a{color:#1F6B6E;cursor:pointer;text-decoration:underline}',
  ...
  function injectChatCSS() {
    var s = ce('style', '', [
      '.chat-toggle{position:fixed;bottom:24px;right:24px;width:56px;height:56px;border-radius:50%;background:#1F6B6E;color:#fff;border:none;font-size:24px;cursor:pointer;box-shadow:0 4px 20px rgba(31,107,110,.4);z-index:1000;display:flex;align-items:center;justify-content:center;transition:transform .2s}',
      ...
      '.chat-head{background:#174E51;color:#F5F1EA;padding:14px 18px;font-weight:600;display:flex;justify-content:space-between;align-items:center;font-size:15px}',
      ...
      '.chat-msg.bot{background:#EDE8DF;color:#1A2332;align-self:flex-start;border-bottom-left-radius:4px}',
      '.chat-msg.user{background:#1F6B6E;color:#fff;align-self:flex-end;border-bottom-right-radius:4px}',
      '.chat-input{display:flex;border-top:1px solid #D4CEC2;padding:12px}',
      '.chat-input input{flex:1;border:1px solid #D4CEC2;border-radius:8px;padding:10px 14px;font-size:14px;outline:none;font-family:Inter,sans-serif}',
      '.chat-input input:focus{border-color:#1F6B6E}',
      '.chat-input button{margin-left:8px;background:#1F6B6E;color:#fff;border:none;border-radius:8px;padding:10px 16px;cursor:pointer;font-size:16px;transition:background .2s}',
      '.chat-input button:hover{background:#174E51}',
      '.chat-suggestions{display:flex;flex-wrap:wrap;gap:6px;margin-top:4px}',
      '.chat-sug{padding:6px 12px;background:#A8C9CA;border:none;border-radius:20px;font-size:12px;color:#1F6B6E;cursor:pointer;transition:background .2s}',
      '.chat-sug:hover{background:#A8C9CA}',
      '.chat-unresolved{display:flex;flex-direction:column;gap:4px;margin-top:4px;align-self:flex-start;max-width:85%}',
      '.chat-unresolved-label{font-size:12px;color:#6B7280;font-style:italic}',
  ...
  function showAdminPanel() {
    ...
    overlay.innerHTML =
      '<div class="admin-panel">' +
        ...
        '</div>' +
        '<div class="admin-body" id="admin-body"><p style="color:#6B7280">Chargement...</p></div>' +
      '</div>';
    document.body.appendChild(overlay);
  ...
  function showDashboard() {
      ...
      '<div class="score-legend" id="score-legend">' +
        ...
        '<div class="score-legend-body" id="score-legend-body" style="display:none">' +
          ...
          '<div class="score-legend-grades">' +
            ...
            '<span class="score-legend-badge" style="background:#1F6B6E">B <small>70-84</small></span>' +
    ...
    function loadMapView() {
      ...
      _loadAllMapProperties(function() {
        ...
        container.innerHTML =
          '<div class="map-split">' +
            '<div class="map-sidebar" id="map-sidebar"><div style="padding:20px;color:#6B7280;text-align:center">Chargement...</div></div>' +
    ...
    function _refreshMapSidebar() {
      ...
      if (props.length === 0) {
        sidebar.innerHTML = '<div style="padding:20px;color:#6B7280;text-align:center">Aucun bien à afficher</div>';
        return;
      }
      ...
      shown.forEach(function(p) {
        var gradeColors = { A: '#059669', B: '#1F6B6E', C: '#d97706', D: '#dc2626' };
        var gc = gradeColors[p.grade] || '#6B7280';
    ...
    function _refreshMapMarkers() {
      ...
      Object.keys(data).forEach(function (id) {
        ...
        var color = gradeColors[p.grade] || '#6B7280';
        ...
        var popup = '<div style="min-width:220px;font-family:Inter,sans-serif">' +
          ...
          '<div style="font-size:16px;font-weight:800;color:#1A2332;margin-bottom:4px">' + priceStr + ' CHF</div>' +
          '<div style="font-size:13px;color:#6B7280;margin-bottom:6px">' + escapeHtml(cleanAddress(p.address, p.city)) + '</div>' +
          '<div style="display:flex;gap:8px;align-items:center;margin-bottom:8px">' +
            ...
            (p.rooms ? '<span style="font-size:12px;color:#6B7280">' + p.rooms + ' pcs</span>' : '') +
            (p.surface ? '<span style="font-size:12px;color:#6B7280">' + p.surface + ' m²</span>' : '') +
          '</div>' +
          ...
          '<a href="#" onclick="openPropertyDetail(' + p.id + ');return false;" style="color:#1F6B6E;font-size:13px;font-weight:600;text-decoration:none">Voir le détail →</a>' +
        '</div>';
  ...
  function _pfFetchSuggestions(query, dd, input) {
    ...
    fetch(url).then(function (r) { return r.json(); }).then(function (data) {
      ...
      items.forEach(function (el) {
        el.addEventListener('mouseenter', function () { el.style.background = '#E4DED2'; });
  ...
  window.showScoreDetail = function(el, e) {
    ...
    function scoreColor(v) { return v >= 80 ? '#059669' : v >= 60 ? '#1F6B6E' : v >= 40 ? '#d97706' : '#dc2626'; }
    ...
    function scoreRow(label, val) {
      ...
      var helpHtml = tip ? ' <span class="st-help" title="' + tip.replace(/"/g, '&quot;') + '" style="display:inline-block;width:14px;height:14px;line-height:14px;text-align:center;font-size:10px;font-weight:700;background:#D4CEC2;color:#4A5568;border-radius:50%;cursor:help;margin-left:4px">?</span>' : '';
      return '<div class="st-row" title="' + tip.replace(/"/g, '&quot;') + '"><span>' + label + helpHtml + '</span>' +
        '<div style="flex:1;margin:0 8px;height:6px;background:#D4CEC2;border-radius:3px"><div style="width:' + val + '%;height:100%;background:' + scoreColor(val) + ';border-radius:3px"></div></div>' +
    ...
    tip._sourceEl = el;
    tip.innerHTML = '<div style="font-weight:700;font-size:14px;margin-bottom:4px;color:#1A2332">Détail du score</div>' +
        '<div style="font-size:11px;color:#6B7280;margin-bottom:10px">Survolez un critère pour l\'explication</div>' +
        ...
        '<button onclick="event.stopPropagation();this.parentNode.remove()" style="margin-top:10px;width:100%;background:#EDE8DF;border:1px solid #D4CEC2;border-radius:6px;padding:5px 12px;cursor:pointer;font-size:12px;color:#4A5568">Fermer</button>';
  ...
  function _detailBar(label, val) {
    val = val || 0;
    var color = val >= 80 ? '#059669' : val >= 60 ? '#1F6B6E' : val >= 40 ? '#d97706' : '#dc2626';
        ...
        if (!data.properties || data.properties.length === 0) {
          ...
          if (!_hasProfile) {
            ...
            list.innerHTML = '<div class="dash-empty">' +
              ...
              '<p>Lou a besoin de vos critères pour chercher. <a href="#" class="open-chat-link" style="color:#1F6B6E;cursor:pointer">Parlez-lui</a> pour démarrer.</p>' +
            '</div>';
          ...
          if (currentNewOnly) {
            ...
            list.innerHTML = '<div class="dash-empty">' +
              ...
              '<div class="first-login-progress" style="margin:20px auto;width:200px;height:4px;background:#D4CEC2;border-radius:4px;overflow:hidden">' +
                '<div style="height:100%;background:#1F6B6E;border-radius:4px;animation:progressBar 90s linear forwards"></div>' +
              '</div>' +
              '<p style="margin-top:12px;color:#6B7280;font-size:13px">Actualisez la page dans un instant, ou <a href="#" class="open-chat-link" style="color:#1F6B6E;cursor:pointer">discutez avec Lou</a> en attendant.</p>' +
              '<button class="dash-btn" id="first-login-refresh" style="margin-top:16px;padding:10px 24px;background:#1F6B6E;color:#fff;border:none;border-radius:8px;cursor:pointer;font-size:14px;font-weight:600">↻ Actualiser les résultats</button>' +
            '</div>';
            ...
            list.innerHTML = '<div class="dash-empty">' +
              ...
              '<p style="margin-top:12px"><a href="#" class="open-chat-link" style="color:#1F6B6E;cursor:pointer">Parlez à Lou</a> pour ajuster, ou modifiez directement votre profil ci-dessus.</p>' +
            '</div>';
          } else {
            ...
            list.innerHTML = '<div class="dash-empty">' +
              ...
              '<p style="margin-top:12px">En attendant, <a href="#" class="open-chat-link" style="color:#1F6B6E;cursor:pointer">parlez à Lou</a> pour affiner vos critères.</p>' +
            '</div>';
            _clearFirstLoginTimers();
            _firstLoginTimers.push(setTimeout(function () {
              loadStats();
  ...
  function renderPropertyCard(p) {
    ...
    var daysColor = daysOnline <= 3 ? '#059669' : daysOnline <= 14 ? '#1F6B6E' : daysOnline <= 30 ? '#d97706' : '#6B7280';
    ...
    if (props[0].score_detail) {
      ...
      scoreKeys.forEach(function (sk) {
        ...
        props.forEach(function (p) {
          ...
          var color = v >= 80 ? '#059669' : v >= 60 ? '#1F6B6E' : v >= 40 ? '#d97706' : '#dc2626';
      ...
      fetch(API + '/api/chat', {
        ...
        .then(function (data) {
          ...
          if (data.profile_ready && !isJWT(TOKEN)) {
            body.insertAdjacentHTML('beforeend', '<div class="chat-msg bot" style="background:#A8C9CA">' +
              'Super, j\'ai tous tes critères ! ' +
              '<a href="#" class="chat-signup-link" style="color:#1F6B6E;font-weight:600">Crée ton espace</a> pour que je lance la recherche.' +
            '</div>');
  ...
  function getDashCSS() {
    return [
      'body{margin:0;background:#F5F1EA;color:#1A2332;font-family:Inter,system-ui,sans-serif;-webkit-font-smoothing:antialiased;font-feature-settings:"ss01" on,"ss02" on}',
      // CRITIQUE (DA V1.0) : Fraunces nécessite l'axe opsz pour rendre à
      // l'épaisseur attendue. Sans cette règle il rend en Times fin. Inter
      // ignore silencieusement opsz (aucun axe opsz sur Inter), donc blanket
      // rule sûre. Font-variation-settings ne cascade pas via font-family,
      // on doit le poser élément par élément.
      'body,h1,h2,h3,h4,h5,h6,.wordmark,.baseline{font-variation-settings:"opsz" 144}',

      // Nav
      '.dash-nav{background:#174E51;padding:14px 32px;display:flex;justify-content:space-between;align-items:center;position:sticky;top:0;z-index:100}',
      '.dash-nav-brand{text-decoration:none;display:flex;align-items:center}',
      // Signature sauge (règle DA V1.0 : sauge = wordmark uniquement). Sur
      // fond teal-deep on prend sage-soft (#B8C9B9), mieux lisible que sage
      // brut tout en gardant la lecture "signature" distincte du teal.
      '.dash-nav .wordmark{color:#F5F1EA;font-size:22px;font-variation-settings:"opsz" 144}',
      '.dash-nav .wordmark__point{color:#B8C9B9}',
      '.dash-nav .wordmark__chevron{stroke:#B8C9B9}',
      '.dash-nav-right{display:flex;align-items:center;gap:16px}',
      '.dash-user-email{color:#6B7280;font-size:13px}',
      '.dash-admin-btn{background:#1F6B6E;border:none;color:#fff;padding:6px 14px;border-radius:8px;cursor:pointer;font-size:13px;font-weight:600;transition:all .2s}',
      '.dash-admin-btn:hover{background:#174E51}',
      '.dash-logout-btn{background:none;border:1px solid #4A5568;color:#6B7280;padding:6px 14px;border-radius:8px;cursor:pointer;font-size:13px;transition:all .2s}',
      '.dash-logout-btn:hover{border-color:#D4CEC2;color:#D4CEC2}',

      // Admin panel
      '.admin-panel{background:#fff;border-radius:16px;padding:28px;width:90vw;max-width:900px;max-height:80vh;overflow-y:auto;box-shadow:0 20px 60px rgba(0,0,0,.3);position:relative;color:#1A2332}',
      '.admin-header{display:flex;justify-content:space-between;align-items:center;margin-bottom:20px}',
      '.admin-header h2{margin:0;font-family:Fraunces,Georgia,serif;font-size:22px}',
      '.admin-header .close-btn{position:static;background:none;border:none;font-size:22px;cursor:pointer;color:#6B7280}',
      '.admin-stats{font-size:15px;color:#6B7280;margin-bottom:16px}',
      '.admin-table{width:100%;border-collapse:collapse;font-size:13px}',
      '.admin-table th{text-align:left;padding:10px 8px;border-bottom:2px solid #D4CEC2;color:#6B7280;font-weight:600;font-size:12px;text-transform:uppercase}',
      '.admin-table td{padding:10px 8px;border-bottom:1px solid #EDE8DF}',
      '.admin-table tr:hover td{background:#F5F1EA}',
      '.admin-plan{background:#A8C9CA;color:#1F6B6E;padding:2px 8px;border-radius:10px;font-size:11px;font-weight:600}',
      ...
      '.dash-select{padding:8px 14px;border:1px solid #D4CEC2;border-radius:8px;font-size:13px;background:#fff;cursor:pointer;color:#4A5568;outline:none}',
      '.dash-select:focus{border-color:#1F6B6E}',
      ...
      '.dash-stat{background:#fff;border:1px solid #D4CEC2;border-radius:12px;padding:20px;text-align:center;transition:box-shadow .2s}',
      '.dash-stat:hover{box-shadow:0 4px 16px rgba(0,0,0,.06)}',
      '.dash-stat-num{font-size:32px;font-weight:700;font-family:Fraunces,Georgia,serif;color:#1A2332}',
      '.dash-stat-lbl{font-size:13px;color:#6B7280;margin-top:4px}',
      '.dash-stat.clickable:hover{border-color:#1F6B6E;box-shadow:0 4px 16px rgba(31,107,110,.12)}',
      '.dash-stat.stat-active{border-color:#1F6B6E;background:#E4DED2;box-shadow:0 4px 16px rgba(31,107,110,.15)}',
      '.dash-stat.stat-active .dash-stat-num{color:#1F6B6E}',
      '.dash-stat.stat-active .dash-stat-lbl{color:#1F6B6E;font-weight:600}',
      '.new-filter-banner{display:flex;align-items:center;justify-content:space-between;background:#E4DED2;border:1px solid #A8C9CA;border-radius:10px;padding:12px 18px;margin-bottom:16px;font-size:14px;color:#1F6B6E;font-weight:600}',
      ...
      '.nearby-banner-active{background:#E4DED2;border-color:#A8C9CA;color:#1F6B6E}',
      '.nearby-expand{padding:7px 14px;background:#1F6B6E;color:#fff;border:none;border-radius:8px;font-size:13px;font-weight:600;cursor:pointer;transition:background .15s}',
      '.nearby-expand:hover{background:#174E51}',
      '.lou-toast{position:fixed;bottom:24px;left:50%;transform:translateX(-50%) translateY(20px);background:#1A2332;color:#fff;padding:12px 20px;border-radius:10px;font-size:14px;font-weight:500;box-shadow:0 10px 25px rgba(0,0,0,.25);opacity:0;transition:opacity .25s ease,transform .25s ease;z-index:9999;max-width:90vw}',
      '.lou-toast-show{opacity:1;transform:translateX(-50%) translateY(0)}',
      '.lou-toast-ok{background:#059669}',
      '.new-filter-clear{background:none;border:1px solid #1F6B6E;color:#1F6B6E;border-radius:6px;padding:4px 12px;cursor:pointer;font-size:13px;font-weight:500;transition:all .2s}',
      '.new-filter-clear:hover{background:#1F6B6E;color:#fff}',

      // Profile bar
      '.dash-profile-bar{margin-bottom:24px}',
      '.dash-profile-tags{display:flex;flex-wrap:wrap;gap:8px}',
      '.ptag{padding:6px 14px;background:#EDE8DF;border-radius:50px;font-size:13px;color:#6B7280}',
      '.ptag.blue{background:rgba(31,107,110,.1);color:#1F6B6E}',
      ...
      '.read-more-link{color:#1F6B6E;font-weight:600;text-decoration:none;white-space:nowrap}',
      '.read-more-link:hover{text-decoration:underline}',
      '.dash-profile-empty{background:#fff;border:1px dashed #D4CEC2;border-radius:12px;padding:20px;text-align:center;color:#6B7280;font-size:14px}',
      '.dash-profile-empty a{color:#1F6B6E;cursor:pointer}',
      '.dash-profile-row{display:flex;align-items:center;justify-content:space-between;gap:12px}',
      '.dash-edit-btn{padding:8px 18px;background:#1F6B6E;color:#fff;border:none;border-radius:8px;font-size:13px;cursor:pointer;white-space:nowrap;transition:background .2s}',
      '.dash-edit-btn:hover{background:#174E51}',
      '.profile-form{background:#fff;border:1px solid #D4CEC2;border-radius:16px;padding:24px 24px 0;margin-top:12px;max-height:75vh;overflow-y:auto}',
      '.pf-row{display:flex;gap:20px;margin-bottom:0}',
      '.pf-flex1{flex:1;min-width:0}',
      '.pf-section{margin-bottom:18px}',
      '.pf-section-title{font-size:14px;font-weight:700;margin-bottom:10px;color:#1A2332}',
      ...
      '.pf-field label{font-size:12px;color:#6B7280;font-weight:600}',
      '.pf-field input,.pf-field select{padding:9px 12px;border:1px solid #D4CEC2;border-radius:8px;font-size:14px;font-family:inherit}',
      '.pf-field input:focus,.pf-field select:focus{border-color:#1F6B6E;outline:none}',
      '.pf-range{display:flex;align-items:center;gap:10px}',
      '.pf-range input[type=range]{flex:1;accent-color:#1F6B6E;cursor:pointer}',
      '.pf-range span{font-size:13px;font-weight:600;color:#1F6B6E;min-width:90px;text-align:right;white-space:nowrap}',
      '.pf-chips{display:flex;flex-wrap:wrap;gap:8px}',
      '.pf-chip{padding:7px 14px;border-radius:20px;font-size:13px;cursor:pointer;border:1px solid #D4CEC2;background:#F5F1EA;color:#6B7280;transition:all .15s;user-select:none}',
      '.pf-chip:hover{border-color:#1F6B6E;color:#1A2332}',
      '.pf-chip.on{background:#1F6B6E;border-color:#1F6B6E;color:#fff}',
      '.pf-zone-list{display:flex;flex-direction:column;gap:6px;margin-bottom:10px}',
      '.pf-zone{display:flex;align-items:center;gap:10px;background:#F5F1EA;border:1px solid #D4CEC2;border-radius:8px;padding:8px 14px;font-size:14px}',
      '.pf-zone span:first-child{flex:1;font-weight:500}',
      '.pf-zone-add{display:flex;gap:8px;align-items:center}',
      '.pf-zone-add input{flex:1;padding:9px 12px;border:1px solid #D4CEC2;border-radius:8px;font-size:14px;font-family:inherit}',
      '.pf-zone-add input:focus{border-color:#1F6B6E;outline:none}',
      '.pf-zone-add select{padding:9px 8px;border:1px solid #D4CEC2;border-radius:8px;font-size:13px}',
      '.pf-add-btn{padding:8px 14px;background:#1F6B6E;color:#fff;border:none;border-radius:8px;font-size:16px;cursor:pointer;font-weight:700}',
      '.pf-actions{display:flex;gap:10px;justify-content:flex-end;margin-top:8px;padding:16px 24px;border-top:1px solid #D4CEC2;position:sticky;bottom:0;background:#fff;border-radius:0 0 16px 16px;z-index:2}',
      '.pf-save-btn{padding:11px 24px;background:#1F6B6E;color:#fff;border:none;border-radius:10px;font-size:14px;cursor:pointer;font-weight:600;transition:all .2s;display:inline-flex;align-items:center;gap:8px}',
      '.pf-save-btn:hover:not(:disabled){background:#174E51;transform:translateY(-1px);box-shadow:0 4px 12px rgba(31,107,110,.3)}',
      '.pf-save-btn:disabled{cursor:wait;opacity:.85}',
      '.pf-cancel-btn{padding:11px 24px;background:#EDE8DF;color:#6B7280;border:none;border-radius:10px;font-size:14px;cursor:pointer}',
      ...
      '.pf-hint{font-size:12px;color:#6B7280;margin-right:auto;align-self:center;font-style:italic}',
      ...
      '.prop-card{background:#fff;border:1px solid #D4CEC2;border-radius:14px;overflow:hidden;transition:all .2s}',
      '.prop-card:hover{box-shadow:0 8px 24px rgba(0,0,0,.08);border-color:#D4CEC2;transform:translateY(-2px)}',
      '.prop-card-top{position:relative;height:280px;background:#D4CEC2;overflow:hidden}',
      ...
      '.prop-img-placeholder{width:100%;height:100%;background:linear-gradient(135deg,#EDE8DF,#D4CEC2);display:flex;align-items:center;justify-content:center;color:#6B7280;font-size:13px}',
      ...
      '.fav-btn{position:absolute;top:12px;right:12px;background:rgba(255,255,255,.9);border:none;width:36px;height:36px;border-radius:50%;font-size:18px;cursor:pointer;color:#6B7280;display:flex;align-items:center;justify-content:center;transition:all .2s}',
      ...
      '.old-price{color:#6B7280;font-size:14px;font-weight:400;margin-left:8px}',
      '.score-tooltip{background:#fff;border:1px solid #D4CEC2;border-radius:12px;padding:14px 16px;box-shadow:0 8px 32px rgba(0,0,0,.18);min-width:200px;max-width:260px;font-size:13px}',
      '.st-row{display:flex;align-items:center;padding:4px 0;color:#4A5568}',
      '.st-row span{min-width:65px;font-size:12px}',
      '.st-row strong{color:#1F6B6E;font-size:13px;min-width:24px;text-align:right}',

      // Card body
      '.prop-card-body{padding:16px}',
      '.prop-price{font-size:20px;font-weight:700;color:#1A2332;margin-bottom:4px}',
      '.prop-price small{font-size:13px;color:#6B7280;font-weight:400;margin-left:2px}',
      '.prop-title{font-size:14px;color:#4A5568;margin-bottom:2px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}',
      '.prop-address{font-size:13px;color:#6B7280;margin-bottom:8px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}',
      '.prop-details{font-size:13px;color:#6B7280;margin-bottom:12px}',

      // Score mini bars
      '.prop-scores-mini{margin-bottom:12px}',
      '.score-mini-row{display:flex;align-items:center;gap:8px;margin-bottom:3px}',
      '.score-mini-lbl{font-size:11px;color:#6B7280;width:42px;text-align:right;flex-shrink:0}',
      '.score-mini-bar{flex:1;height:5px;background:#EDE8DF;border-radius:3px;overflow:hidden}',
      '.score-mini-fill{height:100%;border-radius:3px;transition:width .5s}',
      '.score-mini-val{font-size:11px;color:#6B7280;width:22px;text-align:right}',

      // Card footer
      '.prop-footer{display:flex;justify-content:space-between;align-items:center;padding-top:12px;border-top:1px solid #EDE8DF}',
      '.prop-source{font-size:12px;color:#6B7280;text-transform:capitalize}',
      ...
      '.prop-link{font-size:13px;color:#1F6B6E;text-decoration:none;font-weight:500}',
      '.prop-link:hover{text-decoration:underline}',

      // Loading / Empty
      '.dash-loading{text-align:center;padding:48px;color:#6B7280;font-size:15px}',
      '.dash-empty{text-align:center;padding:48px;color:#6B7280;font-size:15px;background:#fff;border:1px dashed #D4CEC2;border-radius:12px}',
      '.fav-empty{padding:64px 32px;background:linear-gradient(135deg,#F5F1EA 0%,#fff 100%);border:1px solid #D4CEC2}',
      '.fav-empty-icon{font-size:56px;margin-bottom:20px;display:block;filter:grayscale(.3)}',
      '.fav-empty-title{font-family:Fraunces,Georgia,serif;font-size:22px;font-weight:700;color:#1A2332;margin-bottom:8px}',
      '.fav-empty-text{font-size:15px;color:#6B7280;margin-bottom:24px;max-width:380px;margin-left:auto;margin-right:auto;line-height:1.5}',
      '.fav-empty-cta{background:#1F6B6E;color:#fff;border:none;padding:12px 28px;border-radius:10px;font-size:14px;font-weight:600;cursor:pointer;transition:all .2s}',
      '.fav-empty-cta:hover{background:#174E51;transform:translateY(-1px);box-shadow:0 4px 16px rgba(31,107,110,.3)}',
      ...
      '.pag-info{font-size:13px;color:#6B7280;margin-right:12px}',
      '.pag-btn{padding:8px 14px;border:1px solid #D4CEC2;background:#fff;border-radius:8px;font-size:13px;cursor:pointer;color:#4A5568;transition:all .2s}',
      '.pag-btn:hover{border-color:#1F6B6E;color:#1F6B6E}',
      '.pag-btn.active{background:#1F6B6E;color:#fff;border-color:#1F6B6E}',
      ...
      '.detail-gallery{position:relative;width:100%;height:360px;background:#D4CEC2;overflow:hidden}',
      ...
      '.detail-gallery-empty{width:100%;height:200px;background:#EDE8DF;display:flex;align-items:center;justify-content:center;color:#6B7280;font-size:15px}',
      '.detail-body{padding:28px}',
      '.detail-price{font-size:28px;font-weight:800;color:#1A2332;margin-bottom:6px;font-family:Fraunces,Georgia,serif}',
      '.detail-title{font-size:18px;font-weight:600;color:#4A5568;margin-bottom:4px}',
      '.detail-address{font-size:14px;color:#6B7280;margin-bottom:24px}',
      '.detail-section{margin-bottom:24px}',
      '.detail-section h3{font-size:15px;font-weight:700;color:#1A2332;margin-bottom:12px;padding-bottom:8px;border-bottom:1px solid #EDE8DF}',
      '.detail-table{display:grid;grid-template-columns:1fr 1fr;column-gap:24px;row-gap:4px}',
      '.detail-row{display:flex;justify-content:space-between;align-items:center;padding:10px 12px;background:#F5F1EA;border-radius:8px;font-size:14px;gap:12px}',
      '.detail-row span{color:#6B7280}',
      '.detail-row strong{color:#1A2332;text-align:right}',
      '.detail-score-wrap{display:flex;gap:20px;align-items:flex-start;margin-bottom:24px;padding:20px;background:#F5F1EA;border-radius:12px}',
      ...
      '.dsb-row span{min-width:90px;color:#6B7280;display:flex;align-items:center;gap:4px}',
      '.dsb-weight{font-size:11px;font-weight:600;color:#6B7280;letter-spacing:.2px}',
      '.dsb-track{flex:1;height:6px;background:#D4CEC2;border-radius:3px;overflow:hidden}',
      '.dsb-fill{height:100%;border-radius:3px;transition:width .3s}',
      '.dsb-row strong{min-width:24px;text-align:right;font-size:13px;color:#4A5568}',
      '.detail-contact{display:flex;flex-direction:column;gap:8px;font-size:14px}',
      '.detail-contact a{color:#1F6B6E;text-decoration:none}',
      '.detail-contact a:hover{text-decoration:underline}',
      '.detail-features{display:flex;flex-wrap:wrap;gap:8px}',
      '.detail-description{font-size:14px;color:#4A5568;line-height:1.6;margin:0;white-space:pre-line}',
      '.detail-feat{padding:6px 14px;background:#E4DED2;border:1px solid #A8C9CA;border-radius:20px;font-size:13px;color:#1F6B6E}',
      '.detail-sources{display:flex;flex-wrap:wrap;gap:10px}',
      '.detail-source-link{padding:10px 20px;background:#1F6B6E;color:#fff;border-radius:10px;font-size:14px;font-weight:600;text-decoration:none;text-transform:capitalize;transition:background .2s}',
      '.detail-source-link:hover{background:#174E51}',
      '.detail-source-text{padding:10px 20px;background:#EDE8DF;border-radius:10px;font-size:14px;color:#6B7280;text-transform:capitalize}',
      ...
      '.score-legend-toggle{background:none;border:none;color:#1F6B6E;font-size:13px;font-weight:600;cursor:pointer;padding:6px 0;display:flex;align-items:center;gap:4px}',
      '.score-legend-toggle:hover{color:#174E51;text-decoration:underline}',
      '.score-legend-body{background:#F5F1EA;border:1px solid #D4CEC2;border-radius:12px;padding:16px 20px;margin-top:8px}',
      '.score-legend-intro{font-size:13px;color:#4A5568;margin:0 0 12px}',
      ...
      '.score-legend-item{font-size:12px;color:#4A5568;line-height:1.5}',
      '.score-legend-item strong{color:#1A2332}',
      '.score-legend-tip{font-size:12px;color:#6B7280;margin:12px 0 0;font-style:italic}',

      // View tabs
      '.dash-tabs{display:flex;gap:0;margin-bottom:20px;border-bottom:2px solid #D4CEC2}',
      '.dash-tab{padding:10px 20px;border:none;background:none;font-size:14px;font-weight:600;cursor:pointer;color:#6B7280;border-bottom:2px solid transparent;margin-bottom:-2px;transition:all .2s}',
      '.dash-tab:hover{color:#1F6B6E}',
      '.dash-tab.active{color:#1F6B6E;border-bottom-color:#1F6B6E}',
      ...
      '.fav-action-btn{padding:8px 16px;border:1px solid #D4CEC2;background:#fff;border-radius:8px;font-size:13px;cursor:pointer;color:#4A5568;font-weight:500;transition:all .2s}',
      '.fav-action-btn:hover{border-color:#1F6B6E;color:#1F6B6E}',
      '.fav-action-btn.active{background:#1F6B6E;color:#fff;border-color:#1F6B6E}',

      // Favorite card extras
      '.fav-note-preview{font-size:12px;color:#6B7280;background:#F5F1EA;padding:6px 10px;border-radius:6px;margin-bottom:8px;border-left:3px solid #1F6B6E;font-style:italic}',
      '.fav-card-footer{display:flex;justify-content:space-between;align-items:center;padding-top:10px;border-top:1px solid #EDE8DF}',
      '.fav-note-btn{background:none;border:1px solid #D4CEC2;padding:5px 12px;border-radius:6px;font-size:12px;color:#6B7280;cursor:pointer;transition:all .2s}',
      '.fav-note-btn:hover{border-color:#1F6B6E;color:#1F6B6E}',
      '.fav-date{font-size:11px;color:#6B7280}',
      '.fav-compare-check{position:absolute;top:12px;left:52px;width:20px;height:20px;accent-color:#1F6B6E;cursor:pointer;z-index:3}',
      '.dash-stat.clickable:hover{border-color:#1F6B6E;box-shadow:0 4px 16px rgba(31,107,110,.1)}',
      ...
      '.note-modal{background:#fff;border-radius:16px;padding:24px;width:440px;max-width:90vw;box-shadow:0 20px 60px rgba(0,0,0,.3);color:#1A2332}',
      ...
      '.note-modal-close{background:none;border:none;font-size:24px;cursor:pointer;color:#6B7280}',
      '.note-textarea{width:100%;height:120px;border:1px solid #D4CEC2;border-radius:10px;padding:12px;font-size:14px;font-family:Inter,sans-serif;resize:vertical;outline:none;box-sizing:border-box}',
      '.note-textarea:focus{border-color:#1F6B6E;box-shadow:0 0 0 3px rgba(31,107,110,.1)}',
      '.note-modal-footer{display:flex;justify-content:space-between;align-items:center;margin-top:12px}',
      '.note-char-count{font-size:12px;color:#6B7280}',
      '.note-modal-actions{display:flex;gap:8px}',
      '.note-cancel-btn{padding:8px 16px;background:#EDE8DF;border:none;border-radius:8px;font-size:13px;cursor:pointer;color:#6B7280}',
      '.note-save-btn{padding:8px 16px;background:#1F6B6E;color:#fff;border:none;border-radius:8px;font-size:13px;cursor:pointer;font-weight:600;transition:background .2s}',
      '.note-save-btn:hover{background:#174E51}',

      // Compare panel
      '.compare-panel{background:#fff;border:1px solid #D4CEC2;border-radius:16px;padding:24px;margin-bottom:24px;box-shadow:0 4px 16px rgba(0,0,0,.06)}',
      ...
      '.compare-close-btn{background:none;border:none;font-size:22px;cursor:pointer;color:#6B7280}',
      '.compare-scroll{overflow-x:auto}',
      '.compare-table{width:100%;border-collapse:collapse;font-size:13px}',
      '.compare-table th{padding:12px 10px;text-align:center;border-bottom:2px solid #D4CEC2;min-width:140px}',
      ...
      '.compare-th-title{font-size:12px;color:#6B7280;font-weight:400;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;max-width:160px}',
      '.compare-table td{padding:10px;text-align:center;border-bottom:1px solid #EDE8DF}',
      '.compare-label{text-align:left!important;color:#6B7280;font-weight:600}',
      '.compare-best{background:#f0fdf4;color:#059669;font-weight:700}',
      '.compare-note{font-size:12px;color:#6B7280;text-align:left!important;max-width:180px}',
      ...
      '.lou-auth-box h2{font-size:24px;margin:0 0 4px;font-family:Fraunces,Georgia,serif}',
      '.lou-auth-box .sub{font-size:14px;color:#6B7280;margin-bottom:20px}',
      '.lou-auth-box input{width:100%;padding:12px 14px;border:1px solid #D4CEC2;border-radius:10px;margin-bottom:12px;font-size:14px;box-sizing:border-box;outline:none}',
      '.lou-auth-box input:focus{border-color:#1F6B6E;box-shadow:0 0 0 3px rgba(31,107,110,.1)}',
      '.auth-submit{width:100%;padding:13px;border:none;border-radius:10px;background:#1F6B6E;color:#fff;font-size:15px;font-weight:600;cursor:pointer}',
      '.auth-submit:hover{background:#174E51}',
      '.lou-auth-switch{text-align:center;margin-top:14px;font-size:13px;color:#6B7280}',
      '.lou-auth-switch a{color:#1F6B6E;cursor:pointer;text-decoration:underline}',
      '.lou-auth-err{color:#dc2626;font-size:13px;margin-top:8px;display:none;text-align:center}',
      ...
      // Map view
      '.map-view{height:calc(100vh - 280px);min-height:500px;border-radius:12px;overflow:hidden;border:1px solid #D4CEC2}',
      '.map-split{display:flex;height:100%;width:100%}',
      '.map-sidebar{width:380px;min-width:320px;height:100%;overflow-y:auto;background:#F5F1EA;border-right:1px solid #D4CEC2}',
      '.map-sidebar-header{padding:12px 16px;border-bottom:1px solid #D4CEC2;font-size:13px;font-weight:600;color:#6B7280;background:#fff;position:sticky;top:0;z-index:1}',
      '.map-load-more-btn{display:block;width:calc(100% - 24px);margin:12px;padding:12px;background:#fff;border:1px solid #1F6B6E;color:#1F6B6E;border-radius:10px;font-size:14px;font-weight:600;cursor:pointer;transition:all .2s}',
      '.map-load-more-btn:hover{background:#1F6B6E;color:#fff;transform:translateY(-1px);box-shadow:0 4px 12px rgba(31,107,110,.2)}',
      '.map-sidebar-list{padding:8px}',
      '.map-card{display:flex;gap:10px;padding:10px;margin-bottom:6px;background:#fff;border-radius:10px;border:1px solid #D4CEC2;cursor:pointer;transition:all .15s;position:relative}',
      '.map-card:hover{border-color:#1F6B6E;box-shadow:0 2px 8px rgba(31,107,110,.1)}',
      '.map-card-active{border-color:#1F6B6E;box-shadow:0 0 0 2px rgba(31,107,110,.2)}',
      '.map-card-img{width:80px;height:70px;object-fit:cover;border-radius:8px;flex-shrink:0}',
      '.map-card-img-ph{width:80px;height:70px;background:#D4CEC2;border-radius:8px;flex-shrink:0}',
      '.map-card-info{flex:1;min-width:0;display:flex;flex-direction:column;gap:2px}',
      '.map-card-price{font-size:15px;font-weight:700;color:#1A2332}',
      '.map-card-title{font-size:12px;color:#4A5568;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}',
      '.map-card-details{font-size:11px;color:#6B7280}',
      '.map-card-addr{font-size:11px;color:#6B7280;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}',
      ...
      '@media(max-width:480px){',
        ...
        '.map-sidebar{width:100%;height:180px;min-width:unset;border-right:none;border-bottom:1px solid #D4CEC2}',
